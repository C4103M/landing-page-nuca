...
export const Card: React.FC<CardProps> = ({
  ...
  const variantStyles = {
    ...
    // Seção 4 (MEJ): Cards de Impacto Real (substituição do cinza chapado por azul translúcido e cantos assimétricos)
    impact: 'flex flex-col items-start p-5 rounded-[16px_0_16px_0] w-[150px] h-[110px] bg-nuca-primary/5 border border-nuca-primary/10 max-[480px]:w-full max-[480px]:h-auto transition-all duration-300 hover:bg-nuca-primary/10',
